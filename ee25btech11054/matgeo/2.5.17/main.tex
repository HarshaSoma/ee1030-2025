...
\begin{align}
n_1 &= 0, \label{eq:n1}\\
n_2 - n_3 &= 0 \;\;\Rightarrow\;\; n_2=n_3. \label{eq:n2n3}
\end{align}

Thus the general solution is
\begin{align}
\vec{n} &= t\myvec{0\\1\\1}, \quad t\in\mathbb{R}. \label{eq:gensol}
\end{align}

Step 4: Unit vector\\
Since 
\begin{align}
\norm{\myvec{0\\1\\1}} &= \sqrt{2}, \label{eq:norm}
\end{align}
the unit vectors are
\begin{align}
\vec{\hat{n}} &= \pm \frac{1}{\sqrt{2}}\myvec{0\\1\\1} \label{eq:unit1}\\
